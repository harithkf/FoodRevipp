            ...
            <ScrollView>
                <View style={styles.container}>
                    ...
                    <Text style={styles.header}>
                       Islamic Revealed Knowledge and Human Science Cafe
      </Text>

                    <Image
                        style={styles.customimage}
                        source={require('./assets/images/assets/images/hs1.png')}
                    />
                        ...
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            ...
                            <View >
                                <Image
                                    ...
                                    source={require('./assets/images/hs2.jpg')}
                                />
                            </View>
                            <View style={{ paddingLeft: 11 }}>
                                <Image
                                    style={styles.imageCarousel}
                                    source={require('./assets/images/hs3.jpg')}
                                />
                            </View>
                            <View style={{ paddingLeft: 11 }}>
                                <Image
                                    style={styles.imageCarousel}
                                    source={require('./assets/images/hs4.jpg')}
                                />
                            </View>
                            <View style={{ paddingLeft: 11 }}>
                                <Image
                                    style={styles.imageCarousel}
                                    source={require('./assets/images/ruqayyah2.jpg')}
                                />
                            </View>
